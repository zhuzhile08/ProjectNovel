label credits:
    ...
    show Bg Park Path with Dissolve(2.0) 
    scene black with Dissolve(2.0)

    show text "Erklärungen:" with Dissolve(2.0)
    scene black with Dissolve(2.0)
    ...
    scene black with Dissolve(2.0)
    show text "Tester:" with Dissolve(2.0)
    scene black with Dissolve(2.0)
    ...
    show text "gemacht von Thorin, Basti, Till, Zhile" with Dissolve(1.0)
    with Pause(4.0)
    scene black with Dissolve(2.0)
